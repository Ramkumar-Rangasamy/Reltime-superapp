          ...
          <div className="frame"></div>
            ...
            <div className="screen">
                ...
                <div className='center_screen'>
                    {!context.Accountscard && !context.Loanscard && ! context.DEXcard && <img className='phone_logo' src="https://reltime-super-app.netlify.app/images/phone_logo.png" alt="new"  style={{width:"85%", position:"relative", top:"50px", left:"20px"}}/>}
