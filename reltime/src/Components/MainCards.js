...
function MainCards() {
  ...
  return (
    ...
    {/* Accounts Card */}
    <div className="m-2">
      <div className="card card1" style={{ width: '20rem', borderRadius:"5px" }}>
    ...
    {/* Loans Card */}
    <div className="m-2">
      <div className="card card2" style={{ width: '20rem', borderRadius:"5px" }}>
        <div className="card-body">
          <h5 className="card-title text-center mb-4">
            <div className="d-flex justify-content-between align-items-center">
              <span>Loans</span>
    ...
    {/* DEX Card */}
    <div className="m-2">
      <div className="card card3" style={{ width: '20rem', borderRadius:"5px" }}>
        <div className="card-body">
          <h5 className="card-title text-center mb-4">
            <div className="d-flex justify-content-between align-items-center">
              <span>DEX</span>
